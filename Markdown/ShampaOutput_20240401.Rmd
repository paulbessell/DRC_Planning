...
DT::datatable(ZSRiverDT, filter = 'top', extensions = c('Scroller', 'Buttons', 'ColReorder'),
                            ...
                            selection = "none",
              colnames = c("RiverID", "ZS", "Province", "Coordination", "Deploiment", "Debit", "Cas total", "Cas pondérés", "Long. rivière", "Cas / km", "Pondérés / km", "Status"))
```

```{r priority chart, echo = F, eval = params$`Inclure des sites fluviaux`}
