...
params:
  ...
  RiverDischarge: 15
  MinimumCases: 5
  includeSitesRiviere: false
  includeSitesCommunitaire: false
---
...
caseThreshold <- params$MinimumCases ### Add something to look at case density
...
```{r basic data table, echo = F, eval = params$includeSitesRiviere}
...
DT::datatable(ZSRiverDT, filter = 'top', extensions = c('Scroller', 'Buttons', 'ColReorder'),
                            ...
                            selection = "none",
              colnames = c("RiverID", "ZS", "Province", "Deploiment", "Debit", "Cas total", "Cas pondérés", "Long. rivière", "Cas / km", "Pondérés / km"))

```


#### <font size = "+2"> <b> Carte des fleuves </font size></b>
```{r Carte des fleuves, echo = F, out.width='100%', eval = params$includeSitesRiviere}
...
```{r CS data table, echo = F, eval = params$includeSitesCommunitaire}
...
#### Carte des sites communitaire
```{r Carte des SC, echo = F, out.width='100%', eval = params$includeSitesCommunitaire}
